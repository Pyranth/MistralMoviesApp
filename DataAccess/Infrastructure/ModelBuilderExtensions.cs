    ...
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Movie>().HasData(
                ...
                new Movie() { Id = 11, Name = "Forrest Gump", Description = "", CoverImage = "", ReleaseDate = new DateTime(1994, 10, 4)},
                new Movie() { Id = 12, Name = "Inception", Description = "", CoverImage = "", ReleaseDate = new DateTime(1994, 10, 4)},
                new Movie() { Id = 13, Name = "The Lord of the Rings: The Two Towers", Description = "", CoverImage = "", ReleaseDate = new DateTime(1994, 10, 4)},
                new Movie() { Id = 14, Name = "Star Wars: Episode V - The Empire Strikes Back", Description = "", CoverImage = "", ReleaseDate = new DateTime(1994, 10, 4)}
                );
